    ...
    value: function _apiSend(bot) {
      ...
      if (this.properties.text && this.properties.text.length > MSG_MAX_LENGTH) {
        var _ret = function () {
          ...
          var textChunks = splitToChunks(_this2.properties.text, MSG_MAX_LENGTH);

          textChunks.forEach(function (chunk) {
            var properties = Object.assign({}, _this2.properties, { text: chunk });
            // any unclosed tags, text modifiers will not send out, send as pure text
            delete properties.parse_mode;

            promiseChain = promiseChain.then(function () {
              return bot.api[_this2.method](properties);
            });
          });
